...
The six explain the tools in this series unevenly, and the unevenness is worth stating up front. The coordination tools — sprints, review, boards, the ladder, email — inherit the org chart's reasons directly, because they are the org chart's instruments. The data shapes — tables, prose, files, documents — are held up mainly by one of the six, the shipped primitive, and otherwise by something the six don't cover: they match how people perceive, and perception was never a decision either. Org charts say who is responsible; tool stacks say how that responsibility gets exercised. Together they are the machinery an institution uses to defend AI's outputs to itself — and the cage is comfortable precisely because most of it was never a decision.
