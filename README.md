...
| # | Post | What it covers |
|---|---|---|
| 1 | [Persistent Shared Cognitive Workspaces](./shared-cognitive-workspaces.md) | The diagnosis. What the org chart was originally solving for, the six reasons it survives its own origin, what it costs, the four patterns that don't, and the research that already points this way. |
...
| 4 | [The Hybrid Failure Mode](./the-hybrid-failure-mode.md) | Practice. How to run a workspace with role-shaped observability without letting the observability reshape the architecture. Six drift signals, six disciplines, when to give up. |
